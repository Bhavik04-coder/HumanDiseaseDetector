...
const BASE_PATH = '/medicine-scroll'

interface MedicineScrollProps {
  onScrollComplete?: () => void;
}

export default function MedicineScroll({ onScrollComplete }: MedicineScrollProps) {
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-blue-50">
        <div className="text-center">
          ...
          <p className="text-xl font-semibold text-blue-900">Loading Medicine Store...</p>
  ...
  return (
    <div ref={containerRef} className="relative h-[600vh]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        {/* Overlay Text */}
        <MedicineOverlayText scrollProgress={scrollYProgress} />
      </div>
    </div>
  )
}

function MedicineOverlayText({ scrollProgress }: { scrollProgress: any }) {
  const textSegments = [
    {
      range: [0.15, 0.25],
      text: 'Online Medicine Store',
      subtext: 'Genuine medicines at your doorstep',
    },
    {
      range: [0.45, 0.55],
      text: 'Fast Delivery',
